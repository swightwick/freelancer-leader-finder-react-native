...
export const weaponsData: LocationWeapons[] = [
  {
    ...
    weapons: [
      { name: "Shotgun 12G Short H", notes: "Carried by some Pirates" },
  ...
  },
  {
    location: "Bangkok",
    weapons: [
      { name: "Handgun 75R", notes: "Carried by some guards, probably Hotel guards" },
      { name: "Handgun 75S", notes: "Carried by some guards, probably Cross's guards" },
      { name: "Baseball Bat", notes: "In Jordan Cross's office" },
      { name: "Assault Rifle G2", notes: "In the outdoors guard room at the hotel's rear" },
      { name: "Police Baton", notes: "Main hotel security room where the surveillance recorder is." },
      { name: "Tactical Shotgun 12G", notes: "In the Security Room on a desk" },
  ...
  },
  {
    ...
    weapons: [
      { name: "Handgun 75R", notes: "Carried by various guards" },
      { name: "Handgun 75S", notes: "Carried by various guards (Rooftop blue jumpsuits confirmed)" },
      { name: "Chloroform Flask", notes: "On a rack in the room adjoining the initial ICA guard room" },
      { name: "Handgun 9R", notes: "Carried by Hush's bodyguard" },
      { name: "Hackl 9S", notes: "Carried by various guards (Rooftop confirmed)" },
      { name: "SMG Raptor", notes: "Carried by Facility Guards (black shirts)" },
      { name: "Tactical Shotgun 12G", notes: "Carried by various guards" },
    ],
  },
  {
    location: "Colorado",
    weapons: [
      { name: "Handgun 75R", notes: "Carried by a few Militia" },
      { name: "Handgun 75S", notes: "Carried by at least 1 Militia, current location unknown." },
      { name: "Baseball Bat", notes: "Upper floor of the house" },
      { name: "Assault Rifle G1-4", notes: "Carried by various Militia" },
      { name: "Assault Rifle G2", notes: "Carried by some guards. One on the upper walkway into the barn is confirmed." },
      { name: "SMG HX-10", notes: "Carried by various Militia" },
      ...
      { name: "Tactical Shotgun 12G", notes: "Carried by various Militia" },
    ],
  },
  {
    location: "Dartmoor",
    weapons: [
      { name: "Handgun 75R", notes: "Carried by various guards" },
      { name: "Hunting Shotgun", notes: "Mansion ground floor - weapon cabinet, behind glass" },
      { name: "SMG HX-10", notes: "Carried by various guards" },
      { name: "Tactical Shotgun 12G", notes: "Carried by various guards" },
    ],
  },
  {
  ...
  },
  {
    ...
    weapons: [
      ...
      { name: "Tactical Shotgun 12G", notes: "Carried by some private security" },
    ],
  },
  {
    location: "Hokkaido",
  ...
  },
  {
    ...
    weapons: [
      ...
      { name: "Handgun 75R", notes: "Carried by some regular-level Guards" },
      ...
      { name: "Assault Rifle G1-4", notes: "Carried by various Commandos and Elite guards" },
      { name: "Assault Rifle G2", notes: "Carried by some Elite Guard" },
      { name: "Handgun 9S Covert", notes: "Buried in the sewers, get a shovel from the \"Old Oak Tree\" or \"Morgue\" location - https://www.youtube.com/watch?v=pdJX-kS9XwE" },
      { name: "SMG HX-10", notes: "Carried by some Raider guards" },
      ...
      { name: "Tactical Shotgun 12G", notes: "Carried by various Commandos and Elite guards" },
    ],
  },
  {
    location: "Marrakesh",
    weapons: [
      { name: "Handgun 75R", notes: "Carried by embassy guards" },
      { name: "Assault Rifle G1-4", notes: "In the ground-floor weapons room of the school" },
  ...
  },
  {
    location: "Mendoza",
    weapons: [
      { name: "Handgun 75S", notes: "Carried by various guards, mainly gauchos, can also be assembled in the armory while disguised as a mercenary" },
      { name: "Hunting Shotgun", notes: "Inside a locker in the Armory & carried by most gaucho guards" },
      { name: "Woodsman Hunting Rifle", notes: "Top-level walkway of the Silo area" },
      { name: "SMG X2 Covert", notes: "Carried by 1 guard: Asado level, near stairs from the dancefloor, sunglasses." },
      { name: "Handgun 9R", notes: "Carried by some of the suited guards - such as those in the surveillance room" },
      { name: "Sapper's Axe", notes: "Don Yates' Room" },
      { name: "Assault Rifle AR552 Tactical", notes: "Carried by Mercenaries" },
    ],
  },
  {
    location: "Miami",
    weapons: [
      ...
      { name: "Handgun 9R", notes: "Carried by Kronstadt security" },
      { name: "Handgun 9S", notes: "Carried by regular security guards" },
      { name: "SMG HX-10", notes: "Carried by some Kronstadt guards" },
      { name: "Modern Sedative Syringe", notes: "In wall cabinets in the medical area (2x)" },
      { name: "Tactical Shotgun 12G", notes: "Carried by some Kronstadt guards - one on the Kronstadt roof surveillance room" },
    ],
  },
  {
    location: "Mumbai",
    weapons: [
      { name: "Handgun 75R", notes: "Carried by various guards" },
      { name: "Woodsman Hunting Rifle", notes: "Top-level of the Chawls where the Kashmirian is" },
      { name: "Baseball Bat", notes: "On the top-most floor of Rangan's building" },
      { name: "SMG X2", notes: "Carried by some Rangan bodyguards" },
      { name: "Folding Knife", notes: "Embedded in a dartboard in the chawls (public area, not in an apartment)" },
      { name: "Assault Rifle G1-4", notes: "Carried by some elite Rangan tower guards" },
      { name: "SMG HX-10", notes: "Carried by various Guards" },
      { name: "Assault Rifle A33", notes: "Carried by various guards" },
      { name: "Tactical Shotgun 12G", notes: "Carried by various Guards" },
    ],
  },
  {
    location: "New York",
    weapons: [
      { name: "Handgun 75R", notes: "Carried by some guards" },
      ...
      { name: "SMG X2", notes: "Carried by the male would-be bank robber in the right-side front entrance toilets" },
      { name: "Folding Knife", notes: "Carried by female bank robber in the toilets" },
      { name: "Golden Sawed Off Shotgun 12G", notes: "Steal all gold bars from the vault dressed as the bank robber (easter egg) without setting off the lasers (or after alarm ends)" },
      ...
      { name: "Tactical Shotgun 12G", notes: "In the vault security room" },
  ...
  },
  {
    ...
    weapons: [
      { name: "Handgun 75R", notes: "Carried by some guards" },
      { name: "Assault Rifle G2", notes: "Attic Command Center & carried by some CICADA guards" },
      { name: "SMG HX-10", notes: "Carried by CICADA Bodyguards" },
      { name: "Saber", notes: "Museum Room, break display cabinet glass." },
      { name: "Tactical Shotgun 12G", notes: "Basement security room" },
    ],
  },
  {
    location: "Santa Fortuna",
    weapons: [
      { name: "Handgun 75R", notes: "Carried by various guards (Mansion & soldiers)" },
  ...
  },
  {
    ...
    weapons: [
      ...
      { name: "Handgun 75R", notes: "Carried by Bodyguards in suits" },
      { name: "Handgun 75S", notes: "Carried by Mansion Security" },
      ...
      { name: "SMG HX-10", notes: "Carried by some lab guards" },
      { name: "Tactical Shotgun 12G", notes: "Carried by Biolab Security guards" },
    ],
  },
  {
    location: "Whittleton Creek",
    weapons: [
      { name: "Handgun 75R", notes: "In the secret tunnel & lewinsky garden on the table, possibly also carried by some guards" },
      ...
      { name: "SMG HX-10", notes: "Carried by some guards" },
      { name: "SMG HX-7 Covert", notes: "Carried by a Cassidy bodyguard or two patrolling ground floor/garden" },
      { name: "TAC-4 AR Auto", notes: "Top floor Armory of Cassidy's house" },
      { name: "Tactical Shotgun 12G", notes: "Carried by Spencer Green in Cassidy's House" },
    ],
  },
];
